...
### Audio Download
- **NEW**: Download audio only in highest quality (MP3 format)
- The audio will be saved as an MP3 file in the output directory
- Uses best available audio stream and converts to MP3 (320kbps) using ffmpeg
